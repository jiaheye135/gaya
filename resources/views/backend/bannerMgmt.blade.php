...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary title">Banner List</h6>
    </div>
    <div class="card-body">
        <div style="margin-bottom: 1.5em;">
            <button type="button" onclick="redirect('bannerMgmtEdit?type=add')" class="btn btn-info">新增</button>
        </div>
...
<script>
    function delList(obj, id){
        ...
        gMyJs.doAjax(gBasePath + 'ajaxBannerMgmt', {'data': gMyJs.jwtEncode({'id': id, 'ajaxType': 'delList'})},
    ...
    $(function(){
        gDataTable = $('#dataTable').DataTable({
            ...
            "aoColumns": [
                { "sTitle": "Banner 圖片", "mData": "img", "mRender": function(data, type, row){
                ...
                { "sTitle": "管理", "mData": "id", "mRender": function(data, type, row){
                        return '<button type="button" onclick="redirect(\'bannerMgmtEdit?type=edit&id=' + data + '\')" class="btn btn-info">管理</button>';
                    },
