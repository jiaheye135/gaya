...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary title">分類圖片<span class="my-sub_title">(建議尺寸:147*147)</span></h6>
    </div>
    <div class="card-body">
...
<script>
    ...
    function save(btnObj, submitList, groupClassName){
        ...
        formData.append('data', gMyJs.jwtEncode({'data': data, 'type': '{{ $type }}', 'id': {{ $dbId }}, 'ajaxType': 'ajaxAsCategory'}));
