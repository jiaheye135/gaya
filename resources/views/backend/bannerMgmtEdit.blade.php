...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary title">*Banner 圖片<span class="my-sub_title">(建議尺寸:1921*707)</span></h6>
    </div>
    <div class="card-body">
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary title">Banner 連結</h6>
    </div>
    <div class="card-body">
        <div class="item-group">
            <input id="link" name="link" type="text" class="form-control bg-light" placeholder="">
            <div class="my-error_msg"></div>
        </div>    
    </div>
</div>
...
<script>
    ...
    function save(btnObj, submitList, groupClassName){
        ...
        gMyJs.doAjax('{{ $basePath }}ajaxBannerMgmt', formData, 
