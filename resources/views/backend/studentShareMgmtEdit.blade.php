...
<div class="row">
  <div class="col-lg-6">
    <div class="card shadow mb-4">
      <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary title">影片</h6>
      </div>
      <div class="card-body">
      ...
      <div class="card-footer">
        <div class="item-group">
          <input  class="form-control" style="width: 86%; margin-right: 0.5em; display:inline-block;"  name="video_url" type="text" id="video_urls">
          <button class="btn btn-info" style="line-height: 30px; height: 37px;" onclick="gMyJs.reviewVideo();">預覽</button>
        </div>
      </div>
    </div>
  </div>
...
<script>
    ...
    function save(btnObj, submitList, groupClassName){
        ...
        formData.append('data', gMyJs.jwtEncode({'data': data, 'type': '{{ $type }}', 'id': {{ $dbId }}, 'ajaxType': 'ajaxStudentShare'}));
