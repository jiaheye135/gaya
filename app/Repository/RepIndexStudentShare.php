...
class RepIndexStudentShare
{
    ...
    protected $table = 'index_student_share';
    ...
    public function get($where = [], $select = ['*'], $orderBy = [], $getLink = false){
        ...
        $m->LeftJoin('student_share', 'student_share.id', 'index_student_share.article_id');
        $m->LeftJoin('ss_category', 'ss_category.id', '=', 'student_share.category_id');
